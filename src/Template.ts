...
const day1Assistance = {
  push: [new AssistanceLift(PushLifts.OVERHEAD, 15, 4)],
  pull: [new AssistanceLift(PullLifts.ROWS, 15, 4), new AssistanceLift(PullLifts.CURLS, 12, 3, true)],
  core: [new AssistanceLift(CoreLifts.BACK, 15, 4)],
  grip: [new AssistanceLift(GripLifts.CURL, 15, 3), new AssistanceLift(GripLifts.REVCURL, 15, 3)],
  calf: [
...
const day2Assistance = {
  push: [new AssistanceLift(PushLifts.INCLINE, 15, 4)],
  pull: [new AssistanceLift(PullLifts.PULLUPS, 15, 4), new AssistanceLift(PullLifts.CURLS, 12, 3, true)],
  core: [new AssistanceLift(CoreLifts.SPLITSQUAT, 15, 4)]
};

const day3Assistance = {
  push: [new AssistanceLift(PushLifts.DIPS, 15, 4)],
  pull: [new AssistanceLift(PullLifts.LATS, 15, 4), new AssistanceLift(PullLifts.CURLS, 12, 3, true)],
  core: [new AssistanceLift(CoreLifts.LUNGES, 15, 4)],
  grip: [new AssistanceLift(GripLifts.CURL, 6, 3), new AssistanceLift(GripLifts.REVCURL, 6, 3)],
  calf: [
...
const weeks = [new Week(week1sets, fsl, days), new Week(week2sets, fsl, days), new Week(week3sets, fsl, days)];
